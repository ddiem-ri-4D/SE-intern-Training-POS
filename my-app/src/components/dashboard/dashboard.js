            ...
            <div className="card-body">
              ...
              <div className="direct-chat-messages">
                ...
                <div className="direct-chat-msg">
                  ...
                  {/* /.direct-chat-infos */}
                  <img className="direct-chat-img" src="/img/NBT3.jpg" alt="message user image" />
                  {/* /.direct-chat-img */}
                ...
                <div className="direct-chat-msg right">
                  ...
                  {/* /.direct-chat-infos */}
                  <img className="direct-chat-img" src="/img/NBT1.jpg" alt="message user image" />
                  {/* /.direct-chat-img */}
                  <div className="direct-chat-text">
                ...
                <div className="direct-chat-msg">
                  ...
                  {/* /.direct-chat-infos */}
                  <img className="direct-chat-img" src="/img/NBT4.jpg" alt="message user image" />
                  {/* /.direct-chat-img */}
                  <div className="direct-chat-text">
